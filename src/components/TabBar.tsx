...
import { QuickShortcutBar } from './QuickShortcutBar';
...
export const TabBar = () => {
  ...
  return (
    <div className="flex items-center justify-between h-9 bg-black/50 border-b border-white/5 px-2 gap-2 z-30 shrink-0 select-none overflow-x-auto no-scrollbar" role="tablist" aria-label="Open tabs">
