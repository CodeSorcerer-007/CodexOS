...
old_state = """  const [currentPath, setCurrentPath] = useState<string | null>(null);
  const [activeApp, setActiveApp] = useState<'files' | 'docker' | 'network'>('files');"""

new_state = """  const [tabs, setTabs] = useState<Tab[]>(() => {
...
# Inject Tab Bar UI
tab_bar_ui = """      <main className="flex-1 flex flex-col relative z-10">
        {/* Tab Bar */}
