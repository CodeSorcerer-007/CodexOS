...
/// Returns the patch diff for the most recent commit (HEAD vs its parent).
pub fn get_recent_commit_diff_internal(path: &str) -> Result<String, String> {
...
#[tauri::command]
pub fn get_recent_commit_diff(path: String) -> Result<String, String> {
